    ...
    <div class="tp-banner-container">
        <div class="tp-banner">
            <ul>
                ...
                <!-- SLIDE -->
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="300" data-title="Slide 2">
                    <!-- MAIN IMAGE -->
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="300" data-title="Slide 3">
                    <!-- MAIN IMAGE -->
                    <img src="assets/img/sliders/2.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
